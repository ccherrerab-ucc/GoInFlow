    ...
    <form method="POST" action="{{ route('caracteristicas.store') }}">
        ...
        <div class="mb-3">
            ...
            <input type="text"
                   ...
                   placeholder="Ej. Factores/Factor 1 - Misión/Característica 1">
            <div style="font-size:11px;color:var(--gray-500);margin-top:4px;">
                Ruta de la carpeta donde se deben cargar las evidencias de esta característica.
            </div>
            @error('ruta_carpeta')
                <div class="gf-field-error">{{ $message }}</div>
            @enderror
        ...
        {{-- Nota informativa sobre el flujo (ahora automático) --}}
        <div style="background:#eff6ff;border:1px solid #bfdbfe;border-radius:8px;
                    padding:12px 16px;margin-bottom:20px;font-size:12px;color:#1e40af;">
            <i class="bi bi-info-circle-fill me-2"></i>
            El flujo de aprobación se genera automáticamente usando el responsable asignado.
            Las evidencias deberán ser aprobadas por el responsable de la característica.
        </div>
